    ...
    <div className='py-5 px-5 h-screen flex flex-col justify-between'>
      <div>
        ...
        <form onSubmit={submitHandler}>
          ...
          <button disabled={loading} className='bg-[#111] text-white font-semibold mb-3 rounded-lg px-4 py-2 w-full text-lg placeholder:text-base flex justify-center items-center'>
            {loading ? (
              <span className="loader ease-linear rounded-full border-2 border-t-2 border-white h-5 w-5 mr-2 animate-spin"></span>
            ) : (
